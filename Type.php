...
<head>
    ...
    <title>JobLab - Manage Type</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Manage Type</h6>
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":3,"name":"Full Time"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this type?"
                                                            data-action="https://script.viserlab.com/joblab/admin/type/status/3">
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":2,"name":"Part Time"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this type?"
                                                            data-action="https://script.viserlab.com/joblab/admin/type/status/2">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":1,"name":"Full Job"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this type?"
                                                            data-action="https://script.viserlab.com/joblab/admin/type/status/1">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
...
<script>
    ...
    <script>
        ...
        (function($) {
            ...
            let modal = $("#my-modal");
            let action = `https://script.viserlab.com/joblab/admin/type/save`;
            ...
            $('.edit-btn').on('click', function(e) {
                let action = `https://script.viserlab.com/joblab/admin/type/save/:id`;
                let data = $(this).data('edit');
                modal.find('.modal-title').text("Update Type");
