                                ...
                                <ul>
                                            ...
                                            <a href="/salary" class="nav-link">
                                                ...
                                                <span class="menu-title">Salary Period</span>
                                                                                                                ...
                                                                                                                <li class="sidebar-menu-item  ">
                                            <a href="/nofemployee" class="nav-link">
                                                <i class="menu-icon las la-dot-circle"></i>
                                ...
                                <ul>
                                            ...
                                            <a href="/approved" class="nav-link">
                                                ...
                                                <span class="menu-title">Approved Payments</span>
                                                                                                                ...
                                                                                                                <li class="sidebar-menu-item  ">
                                            <a href="/successful" class="nav-link">
                                                <i class="menu-icon las la-dot-circle"></i>
                                            ...
                                            <a href="/rejected" class="nav-link">
                                                ...
                                                <span class="menu-title">Rejected Payments</span>
                                                                                                                ...
                                                                                                                <li class="sidebar-menu-item  ">
                                            <a href="/initiated" class="nav-link">
                                                <i class="menu-icon las la-dot-circle"></i>
                                ...
                                <ul>
                                            ...
                                            <a href="/pendingticket" class="nav-link">
                                                ...
                                                <span class="menu-title">Pending Ticket</span>
                                                                                                                ...
                                                                                                                <li class="sidebar-menu-item  ">
                                            <a href="/closed" class="nav-link">
                                                <i class="menu-icon las la-dot-circle"></i>
                                                <span class="menu-title">Closed Ticket</span>
                                                                                                                                            </a>
                                        </li>
                                                                                                                <li class="sidebar-menu-item  ">
                                            <a href="/answered" class="nav-link">
                                                <i class="menu-icon las la-dot-circle"></i>
...
<!-- navbar-wrapper end -->
    ...
    <button type="button" class="btn btn-outline--primary addBtn btn-sm" data-action="https://script.viserlab.com/joblab/admin/role/store"
        data-image="https://script.viserlab.com/joblab/placeholder-image/50x50" data-title="Add New Role">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/92.png"
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/92"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/92.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:92,&quot;name&quot;:&quot;Voice Artist&quot;,&quot;image&quot;:&quot;92.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/92">
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/91.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/91"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/91.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:91,&quot;name&quot;:&quot;Sound Engineer&quot;,&quot;image&quot;:&quot;91.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/91">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/90.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                                <span>Broadcast Technician</span>
                                            </div>
                                        </td>
                                        <td><span class="badge badge--success">Enabled</span></td>
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/90"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/90.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:90,&quot;name&quot;:&quot;Broadcast Technician&quot;,&quot;image&quot;:&quot;90.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/90">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/89.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/89"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/89.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:89,&quot;name&quot;:&quot;News Anchor&quot;,&quot;image&quot;:&quot;89.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/89">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/88.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/88"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/88.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:88,&quot;name&quot;:&quot;Journalist&quot;,&quot;image&quot;:&quot;88.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/88">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/87.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/87"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/87.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:87,&quot;name&quot;:&quot;Photographer&quot;,&quot;image&quot;:&quot;87.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/87">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/86.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/86"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/86.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:86,&quot;name&quot;:&quot;Hair Stylist&quot;,&quot;image&quot;:&quot;86.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/86">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/85.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/85"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/85.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:85,&quot;name&quot;:&quot;Makeup Artist&quot;,&quot;image&quot;:&quot;85.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/85">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/84.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/84"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/84.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:84,&quot;name&quot;:&quot;Fashion Designer&quot;,&quot;image&quot;:&quot;84.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/84">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/83.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                                <span>Painter</span>
                                            </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/83"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/83.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:83,&quot;name&quot;:&quot;Painter&quot;,&quot;image&quot;:&quot;83.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/83">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/82.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                                <span>Carpenter</span>
                                            </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/82"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/82.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:82,&quot;name&quot;:&quot;Carpenter&quot;,&quot;image&quot;:&quot;82.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/82">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/81.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                                <span>Plumber</span>
                                            </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/81"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/81.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:81,&quot;name&quot;:&quot;Plumber&quot;,&quot;image&quot;:&quot;81.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/81">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/80.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/80"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/80.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:80,&quot;name&quot;:&quot;Electrician&quot;,&quot;image&quot;:&quot;80.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/80">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/79.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/79"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/79.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:79,&quot;name&quot;:&quot;Machine Operator&quot;,&quot;image&quot;:&quot;79.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/79">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/78.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/78"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/78.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:78,&quot;name&quot;:&quot;Supply Chain Manager&quot;,&quot;image&quot;:&quot;78.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/78">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/77.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/77"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/77.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:77,&quot;name&quot;:&quot;Logistics Coordinator&quot;,&quot;image&quot;:&quot;77.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/77">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/76.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/76"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/76.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:76,&quot;name&quot;:&quot;Warehouse Supervisor&quot;,&quot;image&quot;:&quot;76.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/76">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/75.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/75"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/75.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:75,&quot;name&quot;:&quot;Security Guard&quot;,&quot;image&quot;:&quot;75.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/75">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/74.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                                <span>Driver</span>
                                            </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/74"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/74.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:74,&quot;name&quot;:&quot;Driver&quot;,&quot;image&quot;:&quot;74.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/74">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="user gap-2">
                                                <div class="thumb">
                                                    <img src="https://script.viserlab.com/joblab/assets/images/role/73.png"
                                                        alt="role-image" class="plugin_bg">
                                                </div>
                                                <span>Librarian</span>
                                            </div>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary editBtn"
                                                    data-action="https://script.viserlab.com/joblab/admin/role/store/73"
                                                    data-image="https://script.viserlab.com/joblab/assets/images/role/73.png"
                                                    data-title="Edit Role" data-role="{&quot;id&quot;:73,&quot;name&quot;:&quot;Librarian&quot;,&quot;image&quot;:&quot;73.png&quot;,&quot;status&quot;:1,&quot;created_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;,&quot;updated_at&quot;:&quot;2025-04-05T12:36:23.000000Z&quot;}">
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this role?"
                                                        data-action="https://script.viserlab.com/joblab/admin/role/status/73">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                        ...
                        <span class="page-link">‹</span>
                                    ...
                                    <li class="page-item">
                        <a class="page-link" href="https://script.viserlab.com/joblab/admin/role?page=2" rel="next">›</a>
                    </li>
                            </ul>
        </div>
                ...
                <ul class="pagination">
                            ...
                            <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                                                        ...
                                                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/role?page=2">2</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/role?page=3">3</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/role?page=4">4</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/role?page=5">5</a></li>
                                                                                                        
                    
                                            <li class="page-item">
                            <a class="page-link" href="https://script.viserlab.com/joblab/admin/role?page=2" rel="next" aria-label="›">&rsaquo;</a>
                        </li>
                                    </ul>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="PqeKziozwrpf0icDL0LfD5ZmBvfvkYWLewi3OqKl" autocomplete="off">                    <div class="modal-body">
                        <div class="row">
    ...
    <div class="image-upload-wrapper">
        <div class="image-upload-preview "
             style="background-image: url(https://script.viserlab.com/joblab/placeholder-image/50x50)">
        </div>
        <div class="image-upload-input-wrapper">
            <input type="file" class="image-upload-input" name="image" id="imageCreate"
                   accept=".png, .jpg, .jpeg" required>
            <label for="imageCreate" class="bg--primary"><i class="la la-cloud-upload"></i></label>
        </div>
    </div>
</div>
    <div class="mt-2">
        <small class="mt-3 text-muted"> Supported Files:            <b>.png, .jpg, .jpeg.</b>
                            Image will be resized into <b>50x50</b>px                    </small>
    </div>
