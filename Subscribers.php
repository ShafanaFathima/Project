...
<head>
    ...
    <title>JobLab - Subscribers</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Subscribers</h6>
    <div class="d-flex flex-wrap justify-content-end gap-2 align-items-center breadcrumb-plugins">
                <a href="https://script.viserlab.com/joblab/admin/subscriber/send-email" class="btn btn-sm btn-outline--primary"><i
                class="las la-paper-plane"></i>Send Email</a>
        </div>
</div>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                                                    <tr>
                                        <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4f2e293d2035222e232a247d7f7f7c0f28222e2623612c2022">[email&#160;protected]</a></td>
                                        <td>2025-08-26 12:09 PM</td>
                                        <td>
                                            <div class="button--group">
                                                <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                    data-question="Are you sure to remove this subscriber?"
                                                    data-action="https://script.viserlab.com/joblab/admin/subscriber/remove/6">
                                                    <i class="las la-trash"></i> Remove                                                </button>
                                            </div>
                                        </td>
                                    </tr>
                                                                    <tr>
                                        <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="91f0f5fcf8ffd1fcf0f8fdbff2fefc">[email&#160;protected]</a></td>
                                        <td>2025-07-25 06:24 PM</td>
                                        <td>
                                            <div class="button--group">
                                                <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                    data-question="Are you sure to remove this subscriber?"
                                                    data-action="https://script.viserlab.com/joblab/admin/subscriber/remove/5">
                                                    <i class="las la-trash"></i> Remove                                                </button>
                                            </div>
                                        </td>
                                    </tr>
                                                                    <tr>
                                        <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d2a6b7a1a6e3e392a1bba6b7fcb1bdbf">[email&#160;protected]</a></td>
                                        <td>2025-04-05 06:00 AM</td>
                                        <td>
                                            <div class="button--group">
                                                <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                    data-question="Are you sure to remove this subscriber?"
                                                    data-action="https://script.viserlab.com/joblab/admin/subscriber/remove/4">
                                                    <i class="las la-trash"></i> Remove                                                </button>
                                            </div>
                                        </td>
                                    </tr>
                                                                    <tr>
                                        <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c6b2a3b5b286b5afb2a3e8a5a9ab">[email&#160;protected]</a></td>
                                        <td>2025-04-05 06:00 AM</td>
                                        <td>
                                            <div class="button--group">
                                                <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                    data-question="Are you sure to remove this subscriber?"
                                                    data-action="https://script.viserlab.com/joblab/admin/subscriber/remove/3">
                                                    <i class="las la-trash"></i> Remove                                                </button>
                                            </div>
                                        </td>
                                    </tr>
                                                                    <tr>
                                        <td><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="81e3e8fbe0f5e4f1e8e3f8c1ece0e8ede8efe0f5eef3afe2eeec">[email&#160;protected]</a></td>
                                        <td>2025-03-25 12:26 PM</td>
                                        <td>
                                            <div class="button--group">
                                                <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                    data-question="Are you sure to remove this subscriber?"
                                                    data-action="https://script.viserlab.com/joblab/admin/subscriber/remove/2">
                                                    <i class="las la-trash"></i> Remove                                                </button>
                                            </div>
                                        </td>
                                    </tr>
