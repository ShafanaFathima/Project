...
<head>
    ...
    <title>JobLab - Payment History</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Payment History</h6>
    <div class="d-flex flex-wrap justify-content-end gap-2 align-items-center breadcrumb-plugins">
            <form class="d-flex flex-wrap gap-2">
            <div class="input-group w-auto flex-fill">
    <input type="search" name="search" class="form-control bg--white" placeholder="Username / TRX" value="">
    ...
    <div class="card-body">
        <div class="widget-card-inner">
            <div class="widget-card bg--success">
                <a href="https://script.viserlab.com/joblab/admin/payment/successful" class="widget-card-link"></a>
                <div class="widget-card-left">
                    <div class="widget-card-icon">
                        <i class="las la-check-circle"></i>
                    </div>
                    <div class="widget-card-content">
                        <h6 class="widget-card-amount">$5,366.00 USD</h6>
                        <p class="widget-card-title">Successful Payment</p>
                    </div>
                </div>
            ...
            <div class="widget-card bg--warning">
                <a href="https://script.viserlab.com/joblab/admin/payment/pending" class="widget-card-link"></a>
                <div class="widget-card-left">
                    <div class="widget-card-icon">
                        <i class="fas fa-spinner"></i>
                    </div>
                    <div class="widget-card-content">
                        <h6 class="widget-card-amount">$2,297.00 USD</h6>
                        <p class="widget-card-title">Pending Payment</p>
                    </div>
                </div>
                <span class="widget-card-arrow">
                    <i class="las la-angle-right"></i>
            ...
            <div class="widget-card bg--danger">
                <a href="https://script.viserlab.com/joblab/admin/payment/rejected" class="widget-card-link"></a>
                <div class="widget-card-left">
                    <div class="widget-card-icon">
                        <i class="fas fa-ban"></i>
                    </div>
                    <div class="widget-card-content">
                        <h6 class="widget-card-amount">$60.00 USD</h6>
                        <p class="widget-card-title">Rejected Payment</p>
                    </div>
                </div>
                <span class="widget-card-arrow">
                    <i class="las la-angle-right"></i>
            ...
            <div class="widget-card bg--dark">
                <a href="https://script.viserlab.com/joblab/admin/payment/initiated" class="widget-card-link"></a>
                <div class="widget-card-left">
                    <div class="widget-card-icon">
                        <i class="la la-money-check-alt"></i>
                    </div>
                    <div class="widget-card-content">
                        <h6 class="widget-card-amount">$26,919.50 USD</h6>
                        <p class="widget-card-title">Initiated Payment</p>
                    </div>
                </div>
                <span class="widget-card-arrow">
                    <i class="las la-angle-right"></i>
                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="https://script.viserlab.com/joblab/admin/payment/all?method=bank_transfer">
                                                                                                            Bank Transfer
                                                                                                    </a>
                                            </span>
                                            <br>
                                            <small> JS8I6Z176FJS </small>
                                        </td>
                                        <td>
                                            2025-09-23 04:56 AM<br>1 day ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                xyz xyz
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/all?search=sewazxcv">
                                                    <span>@</span>sewazxcv
                                                </a>
                                            </span>
                                        </td>
                                        <td>
                                            $39.00 USD +
                                            <span class="text--danger" title="charge">
                                                $1.39 USD
                                            </span>
                                            <br>
                                        ...
                                        <td><span class="badge badge--dark">Initiated</span></td>
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/192"
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="https://script.viserlab.com/joblab/admin/payment/all?method=Paystack">
                                                                                                            PayStack
                                                                                                    </a>
                                            </span>
                                            <br>
                                            <small> D1BKD5MF7MGR </small>
                                        </td>
                                        <td>
                                            2025-09-22 06:30 PM<br>1 day ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                sandeep kumar
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/all?search=sam2425">
                                                    <span>@</span>sam2425
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/191"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> L2EYHY3JK3Q9 </small>
                                        </td>
                                        <td>
                                            2025-09-20 12:10 PM<br>3 days ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Olivia Miller
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/all?search=khanom">
                                                    <span>@</span>khanom
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/190"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="https://script.viserlab.com/joblab/admin/payment/all?method=Paypal">
                                                                                                            Paypal
                                                                                                    </a>
                                            </span>
                                            <br>
                                            <small> P23HJTFTIJG6 </small>
                                        </td>
                                        <td>
                                            2025-09-20 12:10 PM<br>3 days ago
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/189"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> R5S8177BGVX7 </small>
                                        </td>
                                        <td>
                                            2025-09-17 07:09 AM<br>6 days ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                sandeep kumar
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/188"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="https://script.viserlab.com/joblab/admin/payment/all?method=Stripe">
                                                                                                            Stripe Hosted
                                                                                                    </a>
                                            </span>
                                            <br>
                                            <small> EAGC6AUN66HD </small>
                                        </td>
                                        <td>
                                            2025-09-10 06:21 AM<br>2 weeks ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                fahranenbt fahranenbt
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/all?search=fahranenbt">
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/187"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="https://script.viserlab.com/joblab/admin/payment/all?method=PerfectMoney">
                                                                                                            Perfect Money
                                                                                                    </a>
                                            </span>
                                            <br>
                                            <small> V1E1VHRG2NHQ </small>
                                        </td>
                                        <td>
                                            2025-09-10 06:20 AM<br>2 weeks ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                fahranenbt fahranenbt
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/186"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> BCHQLUZZG17Z </small>
                                        </td>
                                        <td>
                                            2025-09-01 09:51 PM<br>3 weeks ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Mason Garcia
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/all?search=saed12">
                                                    <span>@</span>saed12
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/185"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> F99VH75W6B8Y </small>
                                        </td>
                                        <td>
                                            2025-08-31 01:50 AM<br>3 weeks ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                ABC Private
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/all?search=kacinize">
                                                    <span>@</span>kacinize
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/184"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> R7FSDWNV93FG </small>
                                        </td>
                                        <td>
                                            2025-08-26 01:28 PM<br>4 weeks ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Daryana Kriukova
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/all?search=amcmedica">
                                                    <span>@</span>amcmedica
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/183"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> L2DKE8SMQV65 </small>
                                        </td>
                                        <td>
                                            2025-08-23 04:21 AM<br>1 month ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Ava Miller
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/all?search=mduser123">
                                                    <span>@</span>mduser123
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/182"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> YJ1HVZ2YEEMR </small>
                                        </td>
                                        <td>
                                            2025-08-18 08:11 AM<br>1 month ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                masnuplap masnuplap
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/all?search=masnuplap">
                                                    <span>@</span>masnuplap
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/181"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="https://script.viserlab.com/joblab/admin/payment/all?method=Skrill">
                                                                                                            Skrill
                                                                                                    </a>
                                            </span>
                                            <br>
                                            <small> QA6Z7EU57NMA </small>
                                        </td>
                                        <td>
                                            2025-08-18 07:52 AM<br>1 month ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                riyaan ansari
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/all?search=riyaan0909">
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/180"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 2WV5JAPKURL8 </small>
                                        </td>
                                        <td>
                                            2025-08-18 07:51 AM<br>1 month ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                riyaan ansari
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/179"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/178"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> UI5JISQHG2YF </small>
                                        </td>
                                        <td>
                                            2025-08-17 03:54 AM<br>1 month ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Mohamed Turay
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/all?search=mturay">
                                                    <span>@</span>mturay
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/177"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> PLDWECU2GQL8 </small>
                                        </td>
                                        <td>
                                            2025-08-16 02:57 PM<br>1 month ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Faiz ahmed
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/all?search=gntisgood">
                                                    <span>@</span>gntisgood
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/176"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/175"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> BJUAOQ3A4MYS </small>
                                        </td>
                                        <td>
                                            2025-08-14 07:53 AM<br>1 month ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Faiz ahmed
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/174"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="https://script.viserlab.com/joblab/admin/payment/all?method=Razorpay">
                                                                                                            RazorPay
                                                                                                    </a>
                                            </span>
                                            <br>
                                            <small> A7HNAXI6A2HE </small>
                                        </td>
                                        <td>
                                            2025-08-13 10:00 AM<br>1 month ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Emma Martinez
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/all?search=astonia">
                                                    <span>@</span>astonia
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td><span class="badge badge--success">Succeed</span></td>
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/173"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                        ...
                        <span class="page-link">‹</span>
                                    ...
                                    <li class="page-item">
                        <a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/all?page=2" rel="next">›</a>
                    </li>
                            </ul>
        </div>
                ...
                <ul class="pagination">
                            ...
                            <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                                                        ...
                                                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/all?page=2">2</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/all?page=3">3</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/all?page=4">4</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/all?page=5">5</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/all?page=6">6</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/all?page=7">7</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/all?page=8">8</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/all?page=9">9</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/all?page=10">10</a></li>
                                                                                                        
                    
                                            <li class="page-item">
                            <a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/all?page=2" rel="next" aria-label="›">&rsaquo;</a>
                        </li>
                                    </ul>
            </div>
        </div>
