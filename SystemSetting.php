...
<head>
    ...
    <title>JobLab - System Settings</title>
...
<!-- navbar-wrapper end -->
    ...
    <div class="d-flex flex-wrap justify-content-end gap-2 align-items-center breadcrumb-plugins">
        ...
        <a href="https://script.viserlab.com/joblab/admin/general-setting" class="item-link"></a>
    ...
    <div class="widget-two__content">
        ...
        <p>Configure the fundamental information of the site.</p>
                                    ...
                                    <div class="col-xxl-4 col-md-6 resume_setting searchItems">
                                                <div class="widget-two box--shadow2 b-radius--5  has-link  bg--white">

        <a href="https://script.viserlab.com/joblab/admin/profile-update-setting" class="item-link"></a>
                <i class="lar la-file overlay-icon text--primary"></i>
    ...
    <div class="widget-two__content">
        ...
        <p>Configure profile update progress settings.</p>
    </div>
        ...
        <a href="https://script.viserlab.com/joblab/admin/setting/logo-icon" class="item-link"></a>
    ...
    <div class="widget-two__content">
        ...
        <a href="https://script.viserlab.com/joblab/admin/setting/system-configuration" class="item-link"></a>
    ...
    <div class="widget-two__content">
        ...
        <a href="https://script.viserlab.com/joblab/admin/notification/global/email" class="item-link"></a>
    ...
    <div class="widget-two__content">
        ...
        <p>Control and configure overall notification elements of the system.</p>
                                    ...
                                    <div class="col-xxl-4 col-md-6 payment_gateways searchItems">
                                                <div class="widget-two box--shadow2 b-radius--5  has-link  bg--white">

        <a href="https://script.viserlab.com/joblab/admin/gateway/automatic" class="item-link"></a>
                <i class="las la-credit-card overlay-icon text--primary"></i>
    ...
    <div class="widget-two__content">
        ...
        <p>Configure automatic or manual payment gateways to accept payment from users.</p>
    </div>
        ...
        <a href="https://script.viserlab.com/joblab/admin/seo" class="item-link"></a>
    ...
    <div class="widget-two__content">
        ...
        <a href="https://script.viserlab.com/joblab/admin/frontend/index" class="item-link"></a>
    ...
    <div class="widget-two__content">
        ...
        <a href="https://script.viserlab.com/joblab/admin/frontend/manage-pages" class="item-link"></a>
    ...
    <div class="widget-two__content">
        ...
        <p>Control dynamic and static pages of the system.</p>
                                    ...
                                    <div class="col-xxl-4 col-md-6 social_login_setting searchItems">
                                                <div class="widget-two box--shadow2 b-radius--5  has-link  bg--white">

        <a href="https://script.viserlab.com/joblab/admin/setting/social/credentials" class="item-link"></a>
                <i class="las la-user-circle overlay-icon text--primary"></i>
    ...
    <div class="widget-two__content">
        ...
        <p>Provide the required information here to use the login system by social media.</p>
    </div>
        ...
        <a href="https://script.viserlab.com/joblab/admin/language" class="item-link"></a>
    ...
    <div class="widget-two__content">
        ...
        <a href="https://script.viserlab.com/joblab/admin/extensions" class="item-link"></a>
    ...
    <div class="widget-two__content">
        ...
        <p>Manage extensions of the system here to extend some extra features of the system.</p>
                                    ...
                                    <div class="col-xxl-4 col-md-6 cron_job_setting searchItems">
                                                <div class="widget-two box--shadow2 b-radius--5  has-link  bg--white">

        <a href="https://script.viserlab.com/joblab/admin/cron/index" class="item-link"></a>
                <i class="las la-clock overlay-icon text--primary"></i>
    ...
    <div class="widget-two__content">
        <h3>Cron Job Setting</h3>
        <p>Configure cron job to automate some operations of the system.</p>
    </div>
        ...
        <a href="https://script.viserlab.com/joblab/admin/frontend/frontend-sections/policy_pages" class="item-link"></a>
    ...
    <div class="widget-two__content">
        ...
        <a href="https://script.viserlab.com/joblab/admin/maintenance-mode" class="item-link"></a>
    ...
    <div class="widget-two__content">
        ...
        <a href="https://script.viserlab.com/joblab/admin/cookie" class="item-link"></a>
    ...
    <div class="widget-two__content">
        ...
        <a href="https://script.viserlab.com/joblab/admin/custom-css" class="item-link"></a>
    ...
    <div class="widget-two__content">
        ...
        <p>Write custom css here to modify some styles of frontend of the system if you need to.</p>
                                    ...
                                    <div class="col-xxl-4 col-md-6 sitemap searchItems">
                                                <div class="widget-two box--shadow2 b-radius--5  has-link  bg--white">

        <a href="https://script.viserlab.com/joblab/admin/sitemap" class="item-link"></a>
                <i class="las la-sitemap overlay-icon text--primary"></i>
    ...
    <div class="widget-two__content">
        <h3>Sitemap XML</h3>
        <p>Insert the sitemap XML here to enhance SEO performance.</p>
    </div>

    </div>

                    </div>
                                    <div class="col-xxl-4 col-md-6 robots searchItems">
                                                <div class="widget-two box--shadow2 b-radius--5  has-link  bg--white">

        <a href="https://script.viserlab.com/joblab/admin/robot" class="item-link"></a>
                <i class="las la-robot overlay-icon text--primary"></i>
    ...
    <div class="widget-two__content">
        <h3>Robots txt</h3>
        <p>Insert the robots.txt content here to enhance bot web crawlers and instruct them on how to interact with certain areas of the website.</p>
    </div>
...
<script>
    ...
    <script>
        ...
        <script src="https://script.viserlab.com/joblab/assets/admin/js/highlighter22.js"></script>
    <script>
        (function($) {
            "use strict";
