...
<head>
    ...
    <title>JobLab - Manage Location</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Manage Location</h6>
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":110,"name":"Woodstock","parent_id":100}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/110">
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":109,"name":"Table View","parent_id":100}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/109">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":108,"name":"Newlands","parent_id":100}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/108">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":107,"name":"Rondebosch","parent_id":100}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/107">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":106,"name":"Observatory","parent_id":100}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/106">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":105,"name":"Claremont","parent_id":100}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/105">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":104,"name":"Camps Bay","parent_id":100}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/104">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":103,"name":"Green Point","parent_id":100}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/103">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":102,"name":"Sea Point","parent_id":100}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/102">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":101,"name":"City Bowl","parent_id":100}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/101">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":99,"name":"Al Quoz","parent_id":89}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/99">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":98,"name":"Palm Jumeirah","parent_id":89}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/98">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":97,"name":"JLT","parent_id":89}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/97">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":96,"name":"Business Bay","parent_id":89}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/96">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":95,"name":"Al Barsha","parent_id":89}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/95">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":94,"name":"Dubai Marina","parent_id":89}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/94">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":93,"name":"Bur Dubai","parent_id":89}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/93">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":92,"name":"Deira","parent_id":89}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/92">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":91,"name":"Jumeirah","parent_id":89}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/91">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":90,"name":"Downtown Dubai","parent_id":89}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this location?"
                                                            data-action="https://script.viserlab.com/joblab/admin/location/status/90">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                        ...
                        <span class="page-link">‹</span>
                                    ...
                                    <li class="page-item">
                        <a class="page-link" href="https://script.viserlab.com/joblab/admin/location?page=2" rel="next">›</a>
                    </li>
                            </ul>
        </div>
                ...
                <ul class="pagination">
                            ...
                            <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                                                        ...
                                                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/location?page=2">2</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/location?page=3">3</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/location?page=4">4</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/location?page=5">5</a></li>
                                                                                                        
                    
                                            <li class="page-item">
                            <a class="page-link" href="https://script.viserlab.com/joblab/admin/location?page=2" rel="next" aria-label="›">&rsaquo;</a>
                        </li>
                                    </ul>
            </div>
        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="city" required>
                                <option value="" selected disabled>Select One</option>
                                                                    ...
                                                                    <option value="78">Sydney</option>
                                                                    <option value="67">Mumbai</option>
                                                                    <option value="56">Toronto</option>
                                                                    <option value="45">London</option>
                                                                    <option value="34">Houston</option>
...
<script>
    ...
    <script>
        ...
        (function($) {
            let modal = $("#my-modal");
            let action = `https://script.viserlab.com/joblab/admin/location/save`

            $('.add-btn').on('click', function(e) {
                modal.find('.modal-title').text("New Location");
            ...
            $('.edit-btn').on('click', function(e) {
                let action = `https://script.viserlab.com/joblab/admin/location/save/:id`;
                let data = $(this).data('edit');
                modal.find('.modal-title').text("Update Location");
