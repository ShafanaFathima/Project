...
<head>
    ...
    <title>JobLab - Notification History</title>
                ...
                <div class="table-responsive--sm table-responsive">
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                                                        <tr>
                                <td>
                                                                        <span class="fw-bold">valerian ciorici</span>
                                    <br>
                                    <span class="small">
                                        <a href="https://script.viserlab.com/joblab/admin/users/detail/613"><span>@</span>valerian</a>
                                    </span>
                                ...
                                <td> Job application recived </td>
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/157"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                <td>
                                                                        <span class="fw-bold">Abdullahi Idi Waziri</span>
                                    <br>
                                    <span class="small">
                                        <a href="https://script.viserlab.com/joblab/admin/employers/detail/335"><span>@</span>aiwaziri05</a>
                                    </span>
                                                                    </td>
                                <td>
                                    2025-08-25 12:05 PM
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/156"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                <td>
                                                                        <span class="fw-bold">h s</span>
                                    <br>
                                    <span class="small">
                                        <a href="https://script.viserlab.com/joblab/admin/users/detail/634"><span>@</span>wardruna</a>
                                    </span>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/155"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                <td>
                                                                        <span class="fw-bold">Mohamed Turay</span>
                                    <br>
                                    <span class="small">
                                        <a href="https://script.viserlab.com/joblab/admin/employers/detail/348"><span>@</span>mturay</a>
                                    </span>
                                                                    </td>
                                <td>
                                    2025-08-17 03:54 AM
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/154"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                <td>
                                                                        <span class="fw-bold">Emma Martinez</span>
                                    <br>
                                    <span class="small">
                                        <a href="https://script.viserlab.com/joblab/admin/employers/detail/259"><span>@</span>astonia</a>
                                    </span>
                                                                    </td>
                                <td>
                                    2025-08-13 10:01 AM
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/153"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                ...
                                <td> plan subscribe </td>
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/152"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                <td>
                                                                        <span class="fw-bold">Yvy Dan</span>
                                    <br>
                                    <span class="small">
                                        <a href="https://script.viserlab.com/joblab/admin/employers/detail/345"><span>@</span>yvyliss</a>
                                    </span>
                                                                    </td>
                                <td>
                                    2025-08-10 02:21 PM
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/151"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                <td>
                                                                        <span class="fw-bold">RAMESH KUMAR</span>
                                    <br>
                                    <span class="small">
                                        <a href="https://script.viserlab.com/joblab/admin/employers/detail/331"><span>@</span>adminmk</a>
                                    </span>
                                                                    </td>
                                <td>
                                    2025-08-07 09:00 AM
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/150"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                <td>
                                                                        <span class="fw-bold">Robert Sykes</span>
                                    <br>
                                    <span class="small">
                                        <a href="https://script.viserlab.com/joblab/admin/users/detail/679"><span>@</span>sykesit</a>
                                    </span>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/149"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/148"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                <td>
                                                                        <span class="fw-bold">Elijah Brown</span>
                                    <br>
                                    <span class="small">
                                        <a href="https://script.viserlab.com/joblab/admin/employers/detail/206"><span>@</span>rahulk22</a>
                                    </span>
                                                                    </td>
                                <td>
                                    2025-08-07 12:54 AM
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/147"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/146"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/145"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                <td>
                                                                        <span class="fw-bold">Rajiv Mehta</span>
                                    <br>
                                    <span class="small">
                                        <a href="https://script.viserlab.com/joblab/admin/users/detail/415"><span>@</span>rajivvvvvv</a>
                                    </span>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/144"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                <td>
                                                                        <span class="fw-bold">Noor Fahad</span>
                                    <br>
                                    <span class="small">
                                        <a href="https://script.viserlab.com/joblab/admin/employers/detail/342"><span>@</span>neptastic</a>
                                    </span>
                                                                    </td>
                                <td>
                                    2025-07-29 01:21 PM
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/143"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/142"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                <td>
                                                                        <span class="fw-bold">Soma Shekar</span>
                                    <br>
                                    <span class="small">
                                        <a href="https://script.viserlab.com/joblab/admin/users/detail/413"><span>@</span>somaps</a>
                                    </span>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/141"                                         data-sent_to="[Email is protected for the demo]"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                <td>
                                    ...
                                    <br>
                                    <span class="small">
                                        <a href="https://script.viserlab.com/joblab/admin/employers/detail/12"><span>@</span>employer</a>
                                    </span>
                                                                    </td>
                                <td>
                                    2025-07-20 09:08 AM
                                ...
                                <td> Job application canceled </td>
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/140"                                         data-sent_to="dfas@gmail.com"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/139"                                         data-sent_to="dfas@gmail.com"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                        <tr>
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline--primary notifyDetail"
                                        data-type="email"  data-message="https://script.viserlab.com/joblab/admin/report/email/detail/138"                                         data-sent_to="dfas@gmail.com"><i class="las la-desktop"></i>
                                        Detail</button>
                                </td>
                            </tr>
                                                    </tbody>
        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                        ...
                        <span class="page-link">‹</span>
                                    ...
                                    <li class="page-item">
                        <a class="page-link" href="https://script.viserlab.com/joblab/admin/report/notification/history?page=2" rel="next">›</a>
                    </li>
                            </ul>
        </div>
                ...
                <ul class="pagination">
                            ...
                            <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                                                        ...
                                                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/report/notification/history?page=2">2</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/report/notification/history?page=3">3</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/report/notification/history?page=4">4</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/report/notification/history?page=5">5</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/report/notification/history?page=6">6</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/report/notification/history?page=7">7</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/report/notification/history?page=8">8</a></li>
                                                                                                        
                    
                                            <li class="page-item">
                            <a class="page-link" href="https://script.viserlab.com/joblab/admin/report/notification/history?page=2" rel="next" aria-label="›">&rsaquo;</a>
                        </li>
                                    </ul>
            </div>
        </div>
