...
<head>
    ...
    <title>JobLab - Your Listed Report &amp; Request</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Your Listed Report &amp; Request</h6>
    <div class="d-flex flex-wrap justify-content-end gap-2 align-items-center breadcrumb-plugins">
            <button class="btn btn-sm btn-outline--warning" data-bs-toggle="modal" data-bs-target="#bugModal"><i class="las la-bug"></i> Report a bug</button>
    <a href="https://viserlab.com/support" target="_blank" class="btn btn-sm btn-outline--success"><i class="las la-headset"></i> Request for Support</a>
    </div>
</div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="bugModalLabel">Report & Request</h5>
