...
<head>
    ...
    <title>JobLab - Manage Industry</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Manage Industry</h6>
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":9,"name":"It Industry"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this industry?"
                                                            data-action="https://script.viserlab.com/joblab/admin/industry/status/9">
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":8,"name":"Event Management"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this industry?"
                                                            data-action="https://script.viserlab.com/joblab/admin/industry/status/8">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":7,"name":"Chemicals"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this industry?"
                                                            data-action="https://script.viserlab.com/joblab/admin/industry/status/7">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":6,"name":"Call Center"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this industry?"
                                                            data-action="https://script.viserlab.com/joblab/admin/industry/status/6">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":5,"name":"Business Development"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this industry?"
                                                            data-action="https://script.viserlab.com/joblab/admin/industry/status/5">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":4,"name":"Broadcasting"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this industry?"
                                                            data-action="https://script.viserlab.com/joblab/admin/industry/status/4">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":3,"name":"Banking\/Financial Services"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this industry?"
                                                            data-action="https://script.viserlab.com/joblab/admin/industry/status/3">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":2,"name":"Auto Mobile"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this industry?"
                                                            data-action="https://script.viserlab.com/joblab/admin/industry/status/2">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":1,"name":"Accounting\/Taxation"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this industry?"
                                                            data-action="https://script.viserlab.com/joblab/admin/industry/status/1">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
...
<script>
    ...
    <script>
        ...
        (function($) {
            let modal = $("#my-modal");
            let action = `https://script.viserlab.com/joblab/admin/industry/save`

            $('.add-btn').on('click', function(e) {
                modal.find('.modal-title').text("New Industry");
            ...
            $('.edit-btn').on('click', function(e) {
                let action = `https://script.viserlab.com/joblab/admin/industry/save/:id`;
                let data = $(this).data('edit');

                modal.find('.modal-title').text("Update Industry");
