...
<head>
    ...
    <title>JobLab - Pending Payments</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Pending Payments</h6>
                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="https://script.viserlab.com/joblab/admin/payment/pending?method=bank_transfer">
                                                                                                            Bank Transfer
                                                                                                    </a>
                                            </span>
                                            <br>
                                        ...
                                        <td>
                                            <span class="small">
                                                Mohamed Turay
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=mturay">
                                                    <span>@</span>mturay
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> SK1RZNBL6WCG </small>
                                        </td>
                                        <td>
                                            2025-08-10 02:21 PM<br>1 month ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Yvy Dan
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=yvyliss">
                                                    <span>@</span>yvyliss
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/171"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> H9ZI66WBT354 </small>
                                        </td>
                                        <td>
                                            2025-08-07 08:59 AM<br>1 month ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                RAMESH KUMAR
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=adminmk">
                                                    <span>@</span>adminmk
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/169"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 7Z88DUFXZJOA </small>
                                        </td>
                                        <td>
                                            2025-04-07 06:58 AM<br>5 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Allergic Rhinitis
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=allec10">
                                                    <span>@</span>allec10
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/144"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> EJX6XO2X7OJV </small>
                                        </td>
                                        <td>
                                            2025-04-07 06:28 AM<br>5 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Allergic Rhinitis
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/143"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 5E1VI3AAOA1F </small>
                                        </td>
                                        <td>
                                            2024-07-22 10:59 AM<br>1 year ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                senthil s
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=senthile">
                                                    <span>@</span>senthile
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/117"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 3K8AO9NS1FM7 </small>
                                        </td>
                                        <td>
                                            2024-04-22 05:33 AM<br>1 year ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Olivia Brown
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=ajamirjob">
                                                    <span>@</span>ajamirjob
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/109"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 1J59FFHWM8DW </small>
                                        </td>
                                        <td>
                                            2024-04-21 11:52 AM<br>1 year ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Emma Garcia
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=mmcjob">
                                                    <span>@</span>mmcjob
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/108"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> JU284QYQ8SZ6 </small>
                                        </td>
                                        <td>
                                            2024-04-06 05:34 PM<br>1 year ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Mason Johnson
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=employer">
                                                    <span>@</span>employer
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/105"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 6KQF1QTF7BW4 </small>
                                        </td>
                                        <td>
                                            2024-02-28 11:02 AM<br>1 year ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Noah Johnson
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=mohican94">
                                                    <span>@</span>mohican94
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/101"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> O492PBHTOD5F </small>
                                        </td>
                                        <td>
                                            2024-01-18 07:24 PM<br>1 year ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Elijah Garcia
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=mnomawao">
                                                    <span>@</span>mnomawao
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/97"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 87PRK6ZJ8Y8A </small>
                                        </td>
                                        <td>
                                            2023-08-30 12:54 PM<br>2 years ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                John Davis
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=tanvufc">
                                                    <span>@</span>tanvufc
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/71"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> S18CYW2HK7MP </small>
                                        </td>
                                        <td>
                                            2023-08-22 05:53 PM<br>2 years ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Elijah Martinez
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=testtesttwo">
                                                    <span>@</span>testtesttwo
                                                </a>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/64"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 2HDYWP7JX9GQ </small>
                                        </td>
                                        <td>
                                            2023-07-13 03:54 AM<br>2 years ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Noah Davis
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=empployer">
                                                    <span>@</span>empployer
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/58"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 2CW82GG5YSQS </small>
                                        </td>
                                        <td>
                                            2023-07-10 09:00 PM<br>2 years ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Noah Davis
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/57"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> ZKV7XDK7NFCY </small>
                                        </td>
                                        <td>
                                            2023-07-09 09:38 PM<br>2 years ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Mia Rodriguez
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=Mdjeof">
                                                    <span>@</span>Mdjeof
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/56"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> PE3R5BWC2JUZ </small>
                                        </td>
                                        <td>
                                            2023-06-14 06:09 PM<br>2 years ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Sophia Martinez
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=mizan1424">
                                                    <span>@</span>mizan1424
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/51"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 1W37O1WGYNAB </small>
                                        </td>
                                        <td>
                                            2023-06-07 04:36 PM<br>2 years ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Mason Johnson
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=arulemp">
                                                    <span>@</span>arulemp
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/48"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> D2Y7WX9Q5W8G </small>
                                        </td>
                                        <td>
                                            2023-05-31 09:21 AM<br>2 years ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Mia Jones
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=gogogog">
                                                    <span>@</span>gogogog
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/43"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 5PZQF6MZFX9R </small>
                                        </td>
                                        <td>
                                            2023-04-28 08:05 AM<br>2 years ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Ava Miller
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/pending?search=doctorx">
                                                    <span>@</span>doctorx
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/27"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                        ...
                        <span class="page-link">‹</span>
                                    ...
                                    <li class="page-item">
                        <a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/pending?page=2" rel="next">›</a>
                    </li>
                            </ul>
        </div>
                ...
                <ul class="pagination">
                            ...
                            <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                                                        ...
                                                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/pending?page=2">2</a></li>
                                                                                                        
                    
                                            <li class="page-item">
                            <a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/pending?page=2" rel="next" aria-label="›">&rsaquo;</a>
                        </li>
                                    </ul>
            </div>
        </div>
