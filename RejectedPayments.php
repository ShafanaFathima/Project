...
<head>
    ...
    <title>JobLab - Rejected Payments</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Rejected Payments</h6>
                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="https://script.viserlab.com/joblab/admin/payment/rejected?method=bank_transfer">
                                                                                                            Bank Transfer
                                                                                                    </a>
                                            </span>
                                            <br>
                                            <small> KG69UF5E3N3L </small>
                                        </td>
                                        <td>
                                            2025-04-07 08:54 AM<br>5 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Allergic Rhinitis
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/rejected?search=allec10">
                                                    <span>@</span>allec10
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td><span><span class="badge badge--danger">Rejected</span><br>5 months ago</span></td>
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/148"
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> YFYS7HAC99D2 </small>
                                        </td>
                                        <td>
                                            2025-04-07 06:11 AM<br>5 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Allergic Rhinitis
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/142"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
