                    ...
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                        ...
                                        <td><span class="d-block">1</span></td>
                                        <td><span class="text--small">2025-09-18</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1647"
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1647">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1647"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1647"
                                                        class="dropdown-item">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    ...
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">vfg</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/259">Tech Systems</a>
                                        </td>
                                        <td><span class="d-block">2000</span></td>
                                        <td><span class="text--small">2025-08-13</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1644"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1644">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1644"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1644"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">Basic Information</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/342">Neptastic</a>
                                        </td>
                                        <td><span class="d-block">555</span></td>
                                        <td><span class="text--small"></span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1643"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td> <span class="badge badge--dark">Incomplete</span> </td>
                                        <td>
                                            <button class="btn btn-sm btn-outline--info" data-bs-toggle="dropdown"
                                                type="button" aria-expanded="false">
                                                <i class="las la-ellipsis-v"></i>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1643">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1643"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">OHS Officer</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/342">Neptastic</a>
                                        </td>
                                        <td><span class="d-block">5</span></td>
                                        <td><span class="text--small">2025-08-31</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1642"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1642">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1642"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1642"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">Não sei se</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/342">Neptastic</a>
                                        </td>
                                        <td><span class="d-block">9679</span></td>
                                        <td><span class="text--small">2025-07-30</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1641"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1641">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1641"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1641"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">Test Job</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/324">Smart Enterprises</a>
                                        </td>
                                        <td><span class="d-block">3</span></td>
                                        <td><span class="text--small">2025-08-07</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1640"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1640">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1640"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1640"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">demo</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/12">Nova Labs</a>
                                        </td>
                                        <td><span class="d-block">5</span></td>
                                        <td><span class="text--small">2025-07-20</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1639"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1639">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1639"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1639"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">test 555555555</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/12">Nova Labs</a>
                                        </td>
                                        <td><span class="d-block">2</span></td>
                                        <td><span class="text--small">2025-07-23</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1638"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1638">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1638"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1638"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">tes 5663</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/12">Nova Labs</a>
                                        </td>
                                        <td><span class="d-block">10</span></td>
                                        <td><span class="text--small">2025-07-22</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1637"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1637">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1637"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1637"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">Aperiam eiusmod sit</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/340">Justice and Madden Plc</a>
                                        </td>
                                        <td><span class="d-block">2</span></td>
                                        <td><span class="text--small">2025-07-23</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1636"
                                                class="badge badge--primary">
                                                2
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1636">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1636"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1636"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">Hic mollit odio aspe</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/340">Justice and Madden Plc</a>
                                        </td>
                                        <td><span class="d-block">5</span></td>
                                        <td><span class="text--small">2025-07-23</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1635"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1635">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1635"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1635"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                        ...
                                        <td><span class="d-block">5</span></td>
                                        <td><span class="text--small">2025-07-25</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1634"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1634">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1634"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1634"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">new job 123</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/340">Justice and Madden Plc</a>
                                        </td>
                                        <td><span class="d-block">1</span></td>
                                        <td><span class="text--small">2025-07-23</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1633"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1633">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1633"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1633"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">New Job 1</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/340">Justice and Madden Plc</a>
                                        </td>
                                        <td><span class="d-block">2</span></td>
                                        <td><span class="text--small">2025-08-01</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1632"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1632">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1632"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1632"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">tst 222</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/340">Justice and Madden Plc</a>
                                        </td>
                                        <td><span class="d-block">10</span></td>
                                        <td><span class="text--small">2025-07-26</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1631"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1631">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1631"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1631"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">Test 55566</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/340">Justice and Madden Plc</a>
                                        </td>
                                        <td><span class="d-block">10</span></td>
                                        <td><span class="text--small">2025-07-22</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1630"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1630">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1630"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1630"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">Test 642</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/12">Nova Labs</a>
                                        </td>
                                        <td><span class="d-block">5</span></td>
                                        <td><span class="text--small">2025-07-19</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1629"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1629">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1629"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1629"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
                                                                    ...
                                                                    <tr>
                                        <td>
                                            <span class="d-block">test 31355</span>
                                            <a class="text--small"
                                                href="https://script.viserlab.com/joblab/admin/employers/detail/12">Nova Labs</a>
                                        </td>
                                        <td><span class="d-block">5</span></td>
                                        <td><span class="text--small">2025-07-18</span></td>
                                        <td>
                                            <a href="https://script.viserlab.com/joblab/admin/jobs/apply/list/1628"
                                                class="badge badge--primary">
                                                0
                                            </a>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                    href="https://script.viserlab.com/joblab/admin/jobs/details/1628">
                                                    <i class="las la-desktop"></i> Details                                                </a>
                                                                                                                                                            <button class="dropdown-item confirmationBtn"
                                                            data-action="https://script.viserlab.com/joblab/admin/jobs/featured/1628"
                                                            data-question="Are you sure to featured this job?">
                                                            <i class="las la-arrow-alt-circle-right"></i>
                                                            Featured It                                                        </button>
                                                                                                                                                                                                        <a href="https://script.viserlab.com/joblab/admin/jobs/applicants/1628"
                                                        class="dropdown-item">
                                                        <i class="las la-user-friends"></i>
                                                        Applicants                                                    </a>
                                                                                            </div>
        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                        ...
                        <span class="page-link">‹</span>
                                    ...
                                    <li class="page-item">
                        <a class="page-link" href="https://script.viserlab.com/joblab/admin/jobs?page=2" rel="next">›</a>
                    </li>
                            </ul>
        </div>
        ...
        <div class="d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            <div>
                <p class="small text-muted">
                    ...
                    of
                    <span class="fw-semibold">1647</span>
                    results
                </p>
            </div>
                ...
                <ul class="pagination">
                            ...
                            <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                                                        ...
                                                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/jobs?page=2">2</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/jobs?page=3">3</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/jobs?page=4">4</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/jobs?page=5">5</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/jobs?page=6">6</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/jobs?page=7">7</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/jobs?page=8">8</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/jobs?page=9">9</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/jobs?page=10">10</a></li>
                                                    ...
                                                    <li class="page-item disabled" aria-disabled="true"><span class="page-link">...</span></li>
                                                                                                                        ...
                                                                                                                        <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/jobs?page=82">82</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/jobs?page=83">83</a></li>
                                                                                                        
                    
                                            <li class="page-item">
                            <a class="page-link" href="https://script.viserlab.com/joblab/admin/jobs?page=2" rel="next" aria-label="›">&rsaquo;</a>
                        </li>
                                    </ul>
            </div>
        </div>
