...
<head>
    ...
    <title>JobLab - Manage Number Of Employees</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Manage Number Of Employees</h6>
                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn"
                                                    data-edit='{"id":4,"employees":"1-10"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this number of employees?"
                                                        data-action="https://script.viserlab.com/joblab/admin/number/of/employee/status/4">
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn"
                                                    data-edit='{"id":3,"employees":"11-20"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this number of employees?"
                                                        data-action="https://script.viserlab.com/joblab/admin/number/of/employee/status/3">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn"
                                                    data-edit='{"id":2,"employees":"21-30"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this number of employees?"
                                                        data-action="https://script.viserlab.com/joblab/admin/number/of/employee/status/2">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn"
                                                    data-edit='{"id":1,"employees":"50-100"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-question="Are you sure to disable this number of employees?"
                                                        data-action="https://script.viserlab.com/joblab/admin/number/of/employee/status/1">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
...
<script>
    ...
    <script>
        ...
        (function($) {
            ...
            let modal = $("#my-modal");
            let action = `https://script.viserlab.com/joblab/admin/number/of/employee/save`

            $('.add-btn').on('click', function(e) {
                modal.find('.modal-title').text("Add Number Of Employee");
            ...
            $('.edit-btn').on('click', function(e) {
                let action = `https://script.viserlab.com/joblab/admin/number/of/employee/save/:id`;
                let data = $(this).data('edit');
                modal.find('.modal-title').text("Update Number Of Employee");
