...
<head>
    ...
    <title>JobLab - Manage Shift</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Manage Shift</h6>
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":4,"name":"Night Shift"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this shift?"
                                                            data-action="https://script.viserlab.com/joblab/admin/shift/status/4">
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":3,"name":"First shift"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this shift?"
                                                            data-action="https://script.viserlab.com/joblab/admin/shift/status/3">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":2,"name":"Day Shift"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this shift?"
                                                            data-action="https://script.viserlab.com/joblab/admin/shift/status/2">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":1,"name":"Third Shift"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this shift?"
                                                            data-action="https://script.viserlab.com/joblab/admin/shift/status/1">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
...
<script>
    ...
    <script>
        ...
        (function($) {
            let modal = $("#my-modal");
            let action = `https://script.viserlab.com/joblab/admin/shift/save`

            $('.add-btn').on('click', function(e) {
                modal.find('.modal-title').text("New shift");
            ...
            $('.edit-btn').on('click', function(e) {
                let action = `https://script.viserlab.com/joblab/admin/shift/save/:id`;
                let data = $(this).data('edit');
                modal.find('.modal-title').text("Update Shift");
