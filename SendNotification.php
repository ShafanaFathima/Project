...
<head>
    ...
    <title>JobLab - Notification to Verified Employers</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Notification to Verified Employers</h6>
        ...
        <div class="col-xl-12">
            <div class="card">
                <form class="notify-form" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="e8B6hYDis22Z9BUWCYH988XlaJUiYXNcgL9gSlnM" autocomplete="off">                    <input type="hidden" name="via" value="email">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="being_sent_to" required
                                        data-minimum-results-for-search="1">
                                                                                    <option value="allEmployers" >
                                                All Employers</option>
                                                                                    <option value="selectedEmployers" >
                                                Selected Employers</option>
                                                                                    <option value="withBalance" >
                                                With Balance Employers</option>
                                                                                    <option value="emptyBalanceEmployers" >
                                                Empty Balance Employers</option>
                                                                                    <option value="twoFaDisableEmployers" >
                                                2FA Disable Employers</option>
                                                                                    <option value="twoFaEnableEmployers" >
                                                2FA Enable Employers</option>
                                                                                    <option value="hasDepositedEmployers" >
                                                Employers With Payment</option>
                                                                                    <option value="notDepositedEmployers" >
                                                Employers With Not Payment</option>
                                                                                    <option value="pendingDepositedEmployers" >
                                                Employers With Pending Payment</option>
                                                                                    <option value="rejectedDepositedEmployers" >
                                                Employers With Rejected Payment</option>
                                                                                    <option value="topDepositedEmployers" >
                                                Employers With Top Payment</option>
                                                                                    <option value="pendingTicketEmployers" >
                                                Pending Ticket Employers</option>
                                                                                    <option value="answerTicketEmployers" >
                                                Answer Ticket Employers</option>
                                                                                    <option value="closedTicketEmployers" >
                                                Closed Ticket Employers</option>
                                                                                    <option value="notLoginEmployers" >
                                                Last Few Days Not Login Employers</option>
                                                                                    <option value="notPostJobEmployers" >
                                                Employers Not Post a Job</option>
                                                                                    <option value="notHavePlanSubscription" >
                                                Employers Doesn&#039;t Buy Plan Subscription</option>
                                                                                    <option value="expiredPlanSubscription" >
                                                Subscription Expired Employers</option>
                                                                            </select>
    ...
    <script>
        ...
        (function($) {
            ...
            $('select[name=being_sent_to]').on('change', function(e) {
                ...
                if (methodName == 'SELECTEDEMPLOYERS') {
                    $('.input-append').html(`
                    <div class="form-group" id="user_list_wrapper">
                        <label class="required">Select Employer</label>
                ...
                if (methodName == 'TOPDEPOSITEDEMPLOYERS') {
                    $('.input-append').html(`
                    <div class="form-group">
                        <label class="required">Number Of Top Payment Employer</label>
                ...
                if (methodName == 'NOTLOGINEMPLOYERS') {
                    $('.input-append').html(`
                    <div class="form-group">
            ...
            function fetchUserList() {
                $('.row #user_list').select2({
                    ajax: {
                        url: "https://script.viserlab.com/joblab/admin/employers/list",
                        type: "get",
                        dataType: 'json',
                        delay: 1000,
                        ...
                        processResults: function(response, params) {
                            ...
                            let data = response.employers.data;
                            return {
            ...
            function getUserCount(methodName) {
                ...
                if (methodNameUpper == 'SELECTEDEMPLOYERS' || methodNameUpper == 'ALLEMPLOYERS' || methodNameUpper == 'TOPDEPOSITEDEMPLOYERS' ||
                    methodNameUpper == 'NOTLOGINEMPLOYERS') {
                    $('.userCount').text(0);
                    $('.userCountText').addClass('d-none');
                    return;
                }
                var route = "https://script.viserlab.com/joblab/admin/employers/count-by-segment/:methodName"
