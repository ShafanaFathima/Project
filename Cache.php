...
<head>
    ...
    <title>JobLab - Clear System Cache</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Clear System Cache</h6>
        ...
        <div class="col-xl-8">
            <div class="card">
                ...
                <div class="card-footer">
                    <a href="https://script.viserlab.com/joblab/admin/system/optimize-clear" class="btn btn--primary w-100 h-45">Click to clear</a>
                </div>
            </div>
        </div>
    </div>
