...
<head>
    ...
    <title>JobLab - Successful Payments</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Successful Payments</h6>
                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="https://script.viserlab.com/joblab/admin/payment/successful?method=Razorpay">
                                                                                                            RazorPay
                                                                                                    </a>
                                            </span>
                                            <br>
                                        ...
                                        <td>
                                            <span class="small">
                                                Emma Martinez
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/successful?search=astonia">
                                                    <span>@</span>astonia
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="https://script.viserlab.com/joblab/admin/payment/successful?method=Stripe">
                                                                                                            Stripe Hosted
                                                                                                    </a>
                                            </span>
                                            <br>
                                            <small> 9XC3BBEYFLSS </small>
                                        </td>
                                        <td>
                                            2025-07-29 01:21 PM<br>1 month ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Noor Fahad
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/successful?search=neptastic">
                                                    <span>@</span>neptastic
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/162"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> XXKTRYJUPHTN </small>
                                        </td>
                                        <td>
                                            2025-07-20 08:53 AM<br>2 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Mason Johnson
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/successful?search=employer">
                                                    <span>@</span>employer
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/159"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> RNV3XITH9FZF </small>
                                        </td>
                                        <td>
                                            2025-07-20 08:42 AM<br>2 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                ABC Private
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/successful?search=kacinize">
                                                    <span>@</span>kacinize
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/158"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> PQJZ939EO1M4 </small>
                                        </td>
                                        <td>
                                            2025-07-20 06:51 AM<br>2 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                ABC Private
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/157"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> IE22A5WHC7XA </small>
                                        </td>
                                        <td>
                                            2025-07-20 06:42 AM<br>2 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                ABC Private
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/156"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 47MV56W1FZO6 </small>
                                        </td>
                                        <td>
                                            2025-07-20 06:39 AM<br>2 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                ABC Private
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/155"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> V93AZN2CNSHU </small>
                                        </td>
                                        <td>
                                            2025-07-20 06:37 AM<br>2 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                ABC Private
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/154"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 1KPGQJE6VJFN </small>
                                        </td>
                                        <td>
                                            2025-07-20 06:34 AM<br>2 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                ABC Private
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/153"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="https://script.viserlab.com/joblab/admin/payment/successful?method=Paystack">
                                                                                                            PayStack
                                                                                                    </a>
                                            </span>
                                            <br>
                                            <small> HT8DW8KC5VDP </small>
                                        </td>
                                        <td>
                                            2025-07-20 06:26 AM<br>2 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                ABC Private
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/152"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 85UTWFOFIWJQ </small>
                                        </td>
                                        <td>
                                            2025-07-20 06:19 AM<br>2 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                ABC Private
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/151"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> I8QGDQIZPW4X </small>
                                        </td>
                                        <td>
                                            2025-07-13 08:37 AM<br>2 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Mason Johnson
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/150"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <span class="fw-bold">
                                                <a
                                                    href="https://script.viserlab.com/joblab/admin/payment/successful?method=bank_transfer">
                                                                                                            Bank Transfer
                                                                                                    </a>
                                            </span>
                                            <br>
                                            <small> ACQOFKQ2ELID </small>
                                        </td>
                                        <td>
                                            2025-04-07 08:56 AM<br>5 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Allergic Rhinitis
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/successful?search=allec10">
                                                    <span>@</span>allec10
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td><span><span class="badge badge--success">Approved</span><br>5 months ago</span></td>
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/149"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> EYPB2OJTU8K6 </small>
                                        </td>
                                        <td>
                                            2025-04-07 07:19 AM<br>5 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Allergic Rhinitis
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/146"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 1WXLBM6TFFDF </small>
                                        </td>
                                        <td>
                                            2025-04-07 07:00 AM<br>5 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Allergic Rhinitis
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/145"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> RQ7XJYFEVQLJ </small>
                                        </td>
                                        <td>
                                            2025-04-07 06:05 AM<br>5 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Allergic Rhinitis
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/141"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> CQWZW8EIWTQ1 </small>
                                        </td>
                                        <td>
                                            2025-04-05 12:33 PM<br>5 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Employer Employer
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/successful?search=employer11">
                                                    <span>@</span>employer11
                                                </a>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/140"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 4TY36852J4F8 </small>
                                        </td>
                                        <td>
                                            2025-03-25 12:57 PM<br>5 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Abdullahi Idi Waziri
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/successful?search=abdull">
                                                    <span>@</span>abdull
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/139"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> UAUPJXMZ7YLQ </small>
                                        </td>
                                        <td>
                                            2025-01-14 09:34 AM<br>8 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Yashu Mittal
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/successful?search=academy">
                                                    <span>@</span>academy
                                                </a>
                                            </span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/131"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small> 6Y59DTGEWC7M </small>
                                        </td>
                                        <td>
                                            2024-12-25 12:56 PM<br>8 months ago
                                        </td>
                                        <td>
                                            <span class="small">
                                                Ramesh kumar
                                                <br>
                                                <a href="https://script.viserlab.com/joblab/admin/payment/successful?search=rameshkumar1">
                                                    <span>@</span>rameshkumar1
                                                </a>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <a href="https://script.viserlab.com/joblab/admin/payment/details/130"
                                                    class="btn btn-sm btn-outline--primary ms-1">
                                                    <i class="la la-desktop"></i> Details                                                </a>
                                            </div>
                                        </td>
        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                        ...
                        <span class="page-link">‹</span>
                                    ...
                                    <li class="page-item">
                        <a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/successful?page=2" rel="next">›</a>
                    </li>
                            </ul>
        </div>
                ...
                <ul class="pagination">
                            ...
                            <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                                                        ...
                                                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/successful?page=2">2</a></li>
                                                                                                        
                    
                                            <li class="page-item">
                            <a class="page-link" href="https://script.viserlab.com/joblab/admin/payment/successful?page=2" rel="next" aria-label="›">&rsaquo;</a>
                        </li>
                                    </ul>
            </div>
        </div>
