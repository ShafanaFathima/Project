...
<head>
    ...
    <title>JobLab - Transaction Logs</title>
                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                                    ...
                                    <td>
                                        ...
                                        <br>
                                        <span class="small"> <a href="https://script.viserlab.com/joblab/admin/report/transaction?search=astonia"><span>@</span>astonia</a> </span>

                                        
                                    </td>

                                    <td>
                                        <strong>IITS46XUAALM</strong>
                                    </td>

                                    <td>
                                        2025-08-13 10:01 AM<br>1 month ago
                                    </td>
                                    ...
                                    <td>Starter Plan Subscription</td>
                                </tr>
                                                            <tr>
                                    <td>
                                                                                <span class="fw-bold">Emma Martinez</span>
                                    ...
                                    <td>Payment Via RazorPay - INR</td>
                                </tr>
                                                            <tr>
                                    <td>
                                                                                <span class="fw-bold">Noor Fahad</span>
                                        <br>
                                        <span class="small"> <a href="https://script.viserlab.com/joblab/admin/report/transaction?search=neptastic"><span>@</span>neptastic</a> </span>

                                        
                                    </td>

                                    <td>
                                        <strong>2JK1Q267TZ3X</strong>
                                    </td>
                                    ...
                                    <td>Payment Via Stripe Hosted - USD</td>
                                </tr>
                                                            <tr>
                                    <td>
                                                                                <span class="fw-bold">Mason Johnson</span>
                                        <br>
                                        <span class="small"> <a href="https://script.viserlab.com/joblab/admin/report/transaction?search=employer"><span>@</span>employer</a> </span>

                                        
                                    </td>

                                    <td>
                                        <strong>V2S8FEDCINGU</strong>
                                    </td>

                                    <td>
                                        2025-07-20 08:54 AM<br>2 months ago
                                    </td>
                                    ...
                                    <td>Payment Via Stripe Hosted - USD</td>
                                                            ...
                                                            <tr>
                                    <td>
                                                                                <span class="fw-bold">ABC Private</span>
                                        <br>
                                        <span class="small"> <a href="https://script.viserlab.com/joblab/admin/report/transaction?search=kacinize"><span>@</span>kacinize</a> </span>

                                        
                                    </td>

                                    <td>
                                        <strong>7CQRABBNNCZ2</strong>
                                    </td>
                                    ...
                                    <td>
                                        <strong>LMCE6Y7JAO54</strong>
                                    </td>

                                    <td>
                                        2025-07-20 06:52 AM<br>2 months ago
                                    </td>
                                    ...
                                    <td>
                                        <strong>T4UPZIX8K5M7</strong>
                                    </td>

                                    <td>
                                        2025-07-20 06:36 AM<br>2 months ago
                                    </td>
                                    ...
                                    <td>Payment Via PayStack - NGN</td>
                                </tr>
        ...
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul class="pagination">
                        ...
                        <span class="page-link">‹</span>
                                    ...
                                    <li class="page-item">
                        <a class="page-link" href="https://script.viserlab.com/joblab/admin/report/transaction?page=2" rel="next">›</a>
                    </li>
                            </ul>
        </div>
                ...
                <ul class="pagination">
                            ...
                            <span class="page-link" aria-hidden="true">&lsaquo;</span>
                                                                                                                        ...
                                                                                                                        <li class="page-item active" aria-current="page"><span class="page-link">1</span></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/report/transaction?page=2">2</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/report/transaction?page=3">3</a></li>
                                                                                                                                <li class="page-item"><a class="page-link" href="https://script.viserlab.com/joblab/admin/report/transaction?page=4">4</a></li>
                                                                                                        
                    
                                            <li class="page-item">
                            <a class="page-link" href="https://script.viserlab.com/joblab/admin/report/transaction?page=2" rel="next" aria-label="›">&rsaquo;</a>
                        </li>
                                    </ul>
            </div>
        </div>
