...
<!-- navbar-wrapper end -->
    ...
    <div class="d-flex flex-wrap justify-content-end gap-2 align-items-center breadcrumb-plugins">
        ...
        <div class="col-xxl-3 col-sm-6">
            <a href="https://script.viserlab.com/joblab/admin/users">
<div class="widget-seven bg--primary ">
    <div class="widget-seven__content">
        ...
        <div class="widget-seven__description">
                            <p class="widget-seven__content-title">Total Users</p>
                        <h3 class="widget-seven__content-amount">
                682</h3>
                    </div>
    </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <a href="https://script.viserlab.com/joblab/admin/users/active">
<div class="widget-seven bg--success ">
    <div class="widget-seven__content">
        ...
        <div class="widget-seven__description">
                            <p class="widget-seven__content-title">Active Users</p>
                        <h3 class="widget-seven__content-amount">
                682</h3>
                    </div>
    </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <a href="https://script.viserlab.com/joblab/admin/users/email-unverified">
<div class="widget-seven bg--danger ">
    <div class="widget-seven__content">
        ...
        <div class="widget-seven__description">
                            <p class="widget-seven__content-title">Email Unverified Users</p>
                        <h3 class="widget-seven__content-amount">
                0</h3>
                    </div>
    </div>
        ...
        <div class="col-xxl-3 col-sm-6">
            <a href="https://script.viserlab.com/joblab/admin/users/mobile-unverified">
<div class="widget-seven bg--warning ">
    <div class="widget-seven__content">
        ...
        <div class="widget-seven__description">
                            <p class="widget-seven__content-title">Mobile Unverified Users</p>
                        <h3 class="widget-seven__content-amount">
                0</h3>
                    </div>
    </div>
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-sm-6">
            <a href="https://script.viserlab.com/joblab/admin/employers" class="widget-eight bg--primary  style-two ">
    <div class="widget-eight__description">
        <p class="widget-eight__content-title">Total Employers</p>
        <h3 class="widget-eight__content-amount">351</h3>
    </div>
    <span class="widget-eight__content-icon">
        ...
        <div class="col-xxl-3 col-sm-6">
            <a href="https://script.viserlab.com/joblab/admin/employers/active" class="widget-eight bg--success  style-two ">
    <div class="widget-eight__description">
        <p class="widget-eight__content-title">Active Employers</p>
        <h3 class="widget-eight__content-amount">351</h3>
    </div>
    <span class="widget-eight__content-icon">
        <span class="icon">
        ...
        <div class="col-xxl-3 col-sm-6">
            <a href="https://script.viserlab.com/joblab/admin/employers/email-unverified" class="widget-eight bg--danger  style-two ">
    <div class="widget-eight__description">
        <p class="widget-eight__content-title">Email Unverified Employers</p>
        <h3 class="widget-eight__content-amount">0</h3>
    </div>
    <span class="widget-eight__content-icon">
        <span class="icon">
        ...
        <div class="col-xxl-3 col-sm-6">
            <a href="https://script.viserlab.com/joblab/admin/employers/mobile-unverified" class="widget-eight bg--red  style-two ">
    <div class="widget-eight__description">
        <p class="widget-eight__content-title">Mobile Unverified Employers</p>
        <h3 class="widget-eight__content-amount">0</h3>
    </div>
    <span class="widget-eight__content-icon">
        <span class="icon">
                ...
                <div class="card-body">
                    ...
                    <div class="widget-card-wrapper">
                        <div class="widget-card bg--success">
                            <a href="https://script.viserlab.com/joblab/admin/payment/all" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    ...
                                    <p class="widget-card-title">Total Payments</p>
                                </div>
                            </div>
                        ...
                        <div class="widget-card bg--warning">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">24</h6>
                                    <p class="widget-card-title">Pending Payments</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--danger">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">2</h6>
                                    <p class="widget-card-title">Rejected Payments</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--primary">
                            ...
                            <div class="widget-card-left">
                                ...
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">$87.66 USD</h6>
                                    <p class="widget-card-title">Payments Charge</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
        ...
        <div class="col-xxl-6">
            <div class="card box-shadow3 h-100">
                <div class="card-body">
                    ...
                    <div class="widget-card-wrapper">
                        <div class="widget-card bg--primary">
                            <a href="https://script.viserlab.com/joblab/admin/jobs" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="fas fa-hand-holding-usd"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">1647</h6>
                                    <p class="widget-card-title">Total Jobs</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--success">
                            <a href="https://script.viserlab.com/joblab/admin/jobs/approved" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="fas fa-spinner"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">1620</h6>
                                    <p class="widget-card-title">Approved Job</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--warning">
                            <a href="https://script.viserlab.com/joblab/admin/jobs/pending" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="fas fa-ban"></i>
                                </div>
                                <div class="widget-card-content">
                                    <h6 class="widget-card-amount">2</h6>
                                    <p class="widget-card-title">Pending Jobs</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
                        ...
                        <div class="widget-card bg--danger">
                            <a href="https://script.viserlab.com/joblab/admin/jobs/reject" class="widget-card-link"></a>
                            <div class="widget-card-left">
                                <div class="widget-card-icon">
                                    <i class="fas fa-percentage"></i>
                                </div>
                                <div class="widget-card-content">
                                    ...
                                    <p class="widget-card-title">Rejected Job</p>
                                </div>
                            </div>
                            <span class="widget-card-arrow">
                                <i class="las la-angle-right"></i>
    ...
    <div class="row mb-none-30 mt-30 overflow-hidden">
                ...
                <div class="cron-modal-header">
                    <div class="modal-header-top">
                        <h5 class="modal-title" id="exampleModalLongTitle"><i class="las la-calendar text--primary"></i>
                            Please Set Cron Job </h5>
                        <p>Once per 5-10 minutes is ideal while once every minute is the best option</p>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form-control-lg" id="cronPath"
                            value="curl -s https://script.viserlab.com/joblab/cron" readonly>
                        <button type="button" class="input-group-text copy-text-btn copyCronPath text--primary"><i
                                class="fas fa-copy"></i> <span
                                class="copyText text--primary">Copy</span></button>
                    </div>
                </div>
                <div class="justify-content-between cron-btn-group d-flex gap-2">
                    <a href="https://script.viserlab.com/joblab/admin/cron/index" class="btn btn-outline--primary  w-100 h-45"><i
                            class="fas fa-cog"></i> Cron Job Setting</a>
                    <a href="https://script.viserlab.com/joblab/cron?target=all" class="btn btn-outline--warning w-100 h-45"><i
                            class="fas fa-bolt"></i> Run Manually</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function notify(status, message) {
        ...
        <script src="https://script.viserlab.com/joblab/assets/admin/js/vendor/apexcharts.min.js"></script>
    <script src="https://script.viserlab.com/joblab/assets/admin/js/vendor/chart.js.2.8.0.js"></script>
    ...
    <script src="https://script.viserlab.com/joblab/assets/admin/js/charts.js"></script>
    ...
    <script>
        ...
        const depositWithdrawChart = (startDate, endDate) => {
            ...
            const url = "https:\/\/script.viserlab.com\/joblab\/admin\/chart\/deposit-withdraw";
            $.get(url, data,
        ...
        const transactionChart = (startDate, endDate) => {
            ...
            const url = "https:\/\/script.viserlab.com\/joblab\/admin\/chart\/transaction";
        ...
        piChart(
            ...
            ["Handheld Browser","Chrome","Firefox"],
            [3,34,2]        );

        piChart(
            document.getElementById('userOsChart'),
            ["Android","Mac OS X","Windows 10","Linux","Windows 7"],
            [3,9,25,1,1]        );

        piChart(
            document.getElementById('userCountryChart'),
            ["","Bangladesh","T\u00fcrkiye","Azerbaijan","Mozambique"],
            [34,2,1,1,1]        );
    </script>
    <script>
