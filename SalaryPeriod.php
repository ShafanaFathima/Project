...
<head>
    ...
    <title>JobLab - Manage Salary Period</title>
...
<!-- navbar-wrapper end -->
    ...
    <h6 class="page-title">Manage Salary Period</h6>
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":4,"name":"Weekly"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this salary period?"
                                                            data-action="https://script.viserlab.com/joblab/admin/salary/status/4">
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":3,"name":"Monthly"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this salary period?"
                                                            data-action="https://script.viserlab.com/joblab/admin/salary/status/3">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":2,"name":"Yearly"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this salary period?"
                                                            data-action="https://script.viserlab.com/joblab/admin/salary/status/2">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                <button type="button" class="btn btn-sm btn-outline--primary edit-btn" data-edit='{"id":1,"name":"10 Days"}''>
                                                    <i class="las la-pen"></i>Edit                                                </button>
                                                                                                    <button class="btn btn-sm btn-outline--danger confirmationBtn"
                                                            data-question="Are you sure to disable this salary period?"
                                                            data-action="https://script.viserlab.com/joblab/admin/salary/status/1">
                                                        <i class="la la-eye-slash"></i>Disable                                                    </button>
                                                                                            </div>
                                        </td>
                                    </tr>
...
<script>
    ...
    <script>
        ...
        (function($) {
            let modal = $("#my-modal");
            let action = `https://script.viserlab.com/joblab/admin/salary/save`

            $('.add-btn').on('click', function(e) {
                modal.find('.modal-title').text("New Salary Period");
            ...
            $('.edit-btn').on('click', function(e) {
                let action = `https://script.viserlab.com/joblab/admin/salary/save/:id`;
                let data = $(this).data('edit');
                modal.find('.modal-title').text("Update Salary Period");
